...
class CreateTextQuestion extends Component {
  render() {
    return (
        <div className="Main-question-box">
                <div className="Question-box">
                    <div className="Page-title">
                        Create Passage(text) type question
                    </div>
                    ...
                    <div className="input-holder">
                        <input type="text" name="idealAnswer" placeholder="Type your question instructions here..." />
                    </div>
                    <div className="Question-title">
                        Instructions:
                    </div>
